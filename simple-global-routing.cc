...
main (int argc, char *argv[])
{
  ...
  p2p.SetQueue("ns3::DropTailQueue", "MaxBytes", UintegerValue(7000), "Mode", EnumValue (DropTailQueue::QUEUE_MODE_BYTES));
  p2p.SetDeviceAttribute ("DataRate", StringValue ("1kbps"));
  p2p.SetChannelAttribute ("Delay", StringValue ("10ms"));
  NetDeviceContainer d3d2 = p2p.Install (n3n2);

  //Ptr<PointToPointNetDevice> tmpPtr = DynamicCast<PointToPointNetDevice>(d3d2.Get(1));
  //tmpPtr->SetQueue("ns3::DropTailQueue", "MaxBytes", UintegerValue(1000), "Mode", EnumValue (DropTailQueue::QUEUE_MODE_BYTES));
  ...
  // Set the trace to monitor the behavior at the queue
  ostringstream oss;
  oss << "/NodeList/" << c.Get (2) -> GetId () << "/DeviceList/" << d3d2.Get (1)->GetIfIndex() << "/$ns3::PointToPointNetDevice/TxQueue/$ns3::DropTailQueue/Enqueue";
...
//  oss << "/NodeList/" << "5" << "/DeviceList/" << "4" << "/$ns3::CsmaNetDevice/TxQueue/Drop";
  //oss << "/NodeList/" << c.Get (2) -> GetId () << "/DeviceList/" << d3d2.Get (1)->GetIfIndex() << "/$ns3::PointToPointNetDevice/TxQueue/$ns3::DropTailQueue/Drop";
  //oss << "/NodeList/" << c.Get (2) -> GetId () << "/$ns3::TrafficControlLayer/RootQueueDiscList/" << d3d2.Get (1)->GetIfIndex() << "/InternalQueueList/1/Drop";
  oss << "/NodeList/" << c.Get (2) -> GetId () << "/$ns3::TrafficControlLayer/RootQueueDiscList/" << d3d2.Get (1)->GetIfIndex() << "/Drop";
  cout << oss.str() << endl;
  ...
  //oss << "/NodeList/" << servers.Get (0)->GetId () << "/DeviceList/" << "4" << "/$ns3::CsmaNetDevice/TxQueue/Drop";
//  oss << "/NodeList/" << "5" << "/DeviceList/" << "4" << "/$ns3::CsmaNetDevice/TxQueue/Drop";
  oss << "/NodeList/" << c.Get (2) -> GetId () << "/$ns3::TrafficControlLayer/RootQueueDiscList/" << d3d2.Get (1)->GetIfIndex() << "/BytesInQueue";
  //oss << "/NodeList/" << c.Get (2) -> GetId () << "/DeviceList/" << d3d2.Get (1)->GetIfIndex() << "/$ns3::PointToPointNetDevice/TxQueue/$ns3::DropTailQueue/BytesInQueue";
  cout << oss.str() << endl;
